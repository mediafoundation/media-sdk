...
module.exports = () => {
    ...
    const getPaginatedDeals = async (contract, start, count) => {
        let deals = []
    ...
    const compareDealsResourcesWithResources = async (dealsIds, resourcesIds) => {
        let difference = [];
    ...
    const getDeal = async (contract, dealId) => {
